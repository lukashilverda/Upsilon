...
void initClocks() {
  /* N0120 placeholder clock tree.
   * The current repo still lacks a real STM32H725 register model, so this
   * keeps the board buildable while the H7 limits are documented separately. */
  /* System clock
   * Temporary placeholder copied from the N0110 bring-up.
   * Replace with a real STM32H725 clock tree before shipping. */
