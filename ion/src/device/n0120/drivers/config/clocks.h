...
/* N0120 placeholder clock limits.
 * The repo does not yet model the STM32H725 clock tree, so this file keeps a
 * compileable N0110-era configuration until the H7 register layer exists. */
